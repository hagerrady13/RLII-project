...
ax.text(x_axis[-6], means[-6, p2], 'Actor-Critic, ' + r'$\alpha_{w}x8=2^{0}$', color=colors[p2],fontsize=9)
...
ax.text(x_axis[-5], means[-5], 'Sarsa, ' + r'$\epsilon$=' + str(0.0), color=colors[p2], fontsize=11)
...
ax.set_title("Mountain Car - " + r'$\epsilon$: Sarsa exploration parameter, '+ r'$\alpha_{w}$: Critic step size ', fontsize=10)
